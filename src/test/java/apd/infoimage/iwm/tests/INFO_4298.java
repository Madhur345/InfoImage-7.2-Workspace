 ...
 * @author PradhanJ
 * INFO-4298
 * Test to verify the Nested search functionality 
 * with (>=)greaterthan equals to using query builder in iwm. *
 */
public class INFO_4298 extends SuperClassIWM{
	@BeforeMethod
	public void setUp() {
	...
	public void testVerifyNestedSearchWith_GreaterThanEqualTo() {
		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-4298 is Test to verify the Nested search functionality "
				+ "with (>=)greaterthan equals to using query builder in iwm.");
		ATUReports.setAuthorInfo("Jayashri", "MAY-2018", "0.3");

		try {
			Log.startTestCase(
					"INFO_4298_VerifyNestedSearchWith_GreaterThanEqualTo");
			...
			ATUReports.add(
					...
					+ "with (>=)greaterthan equals to using query builder in iwm.",
					LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail(" Nested search functionality with (>=)greaterthan equals to test failed");
		}
		finally {
			Log.endTestCase("INFO_4298_VerifyNestedSearchWith_GreaterThanEqualTo");
