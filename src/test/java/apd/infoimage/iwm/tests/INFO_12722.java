 ...
 */
public class INFO_12722 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testVerifyRecentSearchHistoryUsingRefinedSearchForDocumentWorkitemUnderDOMAINLevel() {

		ATUReports.setTestCaseReqCoverage("This Scenario is To verify 'Recent search' history using 'Refined Search' for document type of workitem under DOMAIN level");
		ATUReports.setAuthorInfo("Suman", "AUG-2018", "0.3");
		try {
			Log.startTestCase("INFO_12722_VerifyRecentSearchHistoryUsingRefinedSearchForDocumentWorkitemUnderDOMAINLevelTest");
			Reporter.log("INFO_12722_VerifyRecentSearchHistoryUsingRefinedSearchForDocumentWorkitemUnderDOMAINLevelTest", true);
			prop = new Properties();
			...
			Reporter.log("Class Name : INFO_12722_VerifyRecentSearchHistoryUsingRefinedSearchForDocumentWorkitemUnderDOMAINLevelTest", true);
			ATUReports.add("Class Name : INFO_12722_VerifyRecentSearchHistoryUsingRefinedSearchForDocumentWorkitemUnderDOMAINLevelTest", true);
			Log.info("Class Name : INFO_12722_VerifyRecentSearchHistoryUsingRefinedSearchForDocumentWorkitemUnderDOMAINLevelTest");
			...
			Log.endTestCase("INFO_12722_VerifyRecentSearchHistoryUsingRefinedSearchForDocumentWorkitemUnderDOMAINLevelTest");
		}
	}
