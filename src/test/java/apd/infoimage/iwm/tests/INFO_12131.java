 ...
 * INFO-12131
 * This class verifies deletion of single TIF/JPG/PNG/PDF/RTF page asynchronously under imports when one import is open for Document type of workitem
 */
public class INFO_12131 extends SuperClassIWM{
	...
	public void testVerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForDocumentWorkitem(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-12131 is for Verifying deletion of single TIF/JPG/PNG/PDF/RTF page asynchronously under imports when one import is open for Document type of workitem");
		ATUReports.setAuthorInfo("Suman","SEP-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_12131_VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest");
			...
			Reporter.log("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest",true);
			ATUReports.add("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest",true);
			Log.info("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest");
		...
		{
			e.printStackTrace();
			Reporter.log("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForDocumentWorkitem Test is failed.", true);
			ATUReports.add("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForDocumentWorkitem Test is failed.",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForDocumentWorkitem Test is failed.");
			Log.error(e.getMessage());
		}
		finally {
			Log.endTestCase("INFO_12131_VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest");
		}
	}
