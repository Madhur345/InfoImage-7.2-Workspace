 ...
 * @author PradhanJ
 * INFO-7185
 * To export a duplicate image from document type of workitem in IWM
 */
public class INFO_7185 extends SuperClassIWM {
	...
	public void testExportDuplicateImageFromDocTypeWorkitem() {

		Log.startTestCase("INFO_7185_ExportDuplicateImageFromDocTypeWorkitem");

		ATUReports.setTestCaseReqCoverage(
				"INFO-7185 This Scenario is To export a duplicate image from document type of workitem in IWM");
