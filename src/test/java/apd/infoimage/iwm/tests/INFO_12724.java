 ...
 * INFO_12724
 * This class verify 'Recent search' history using 'Refined search' for Folder type of workitem under ENTERPRISE level
 */
public class INFO_12724 extends SuperClassIWM {
	@BeforeMethod
	public void beforMethod() {
		Driver.driver.get(prop.getProperty("appUrl"));
		util.waitForPageToLoad();
		lp.loginToApp("userName1", "password", "domain", "role9");
		util.waitForPageToLoad();
	}
	...
	public void testVerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevel() {

		ATUReports.setTestCaseReqCoverage("This Scenario is To verify 'Recent search' history using 'Refined Search' for Folder type of workitem under ENTERPRISE level");
		ATUReports.setAuthorInfo("Suman", "AUG-2018", "0.3");
		try {
			Log.startTestCase("INFO_12724_VerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevelTest");
			Reporter.log("INFO_12724_VerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevelTest", true);
			prop = new Properties();
			...
			Reporter.log("Class Name : INFO_12724_VerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevelTest", true);
			ATUReports.add("Class Name : INFO_12724_VerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevelTest", true);
			Log.info("Class Name : INFO_12724_VerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevelTest");
			...
			e.printStackTrace();
			Reporter.log("failed to execute VerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevel test", true);
			ATUReports.add("failed to execute VerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevel test", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("failed to execute VerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevel test");
			Log.error(e.getMessage());
		} finally {
			Log.endTestCase("INFO_12724_VerifyRecentSearchHistoryUsingRefinedSearchForFolderWorkitemUnderENTERPRISELevelTest");
		}
	}
