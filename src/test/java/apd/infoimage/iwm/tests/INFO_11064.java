...
/**
 * @author DashBisw INFO_11064 This class is To verify "No Alert Message At The
 *         Time You Type A Not Supported Character In The Workitem Name Field
 *         While Performing Rename Workitem Type Of Workitem". 27/07/2018
 */
public class INFO_11064 extends SuperClassIWM {
	...
	public void afterMethod() {
		Log.endTestCase(
				"INFO_11064_VerifyNoAlertMessageAtTheTimeYouTypeANotSupportedCharacterInTheWorkitemNameFieldWhilePerformingRenameWorkitemForDocumentTypeOfWorkitem");
	...
	public void VerifyAlertMessage() {
		Log.startTestCase(
				"INFO_11064_VerifyNoAlertMessageAtTheTimeYouTypeANotSupportedCharacterInTheWorkitemNameFieldWhilePerformingRenameWorkitemForDocumentTypeOfWorkitem");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO_11064  is To verify"
					+ "No Alert Message At The Time You Type A Not Supported Character In The Workitem Name Field While Performing Rename Workitem For Document Type Of Workitem");
			ATUReports.setAuthorInfo("DashBisw", "JULY-2018", "0.4");
			...
			Reporter.log("Rename accept button clicked");
			Log.info("Rename accept button clicked");

			Reporter.log("Alert accept button clicked");
			...
			ATUReports.add(
					"Verify No Alert Message At The Time You Type A Not Supported Character In The Workitem Name Field While Performing Rename Workitem For Document Type Of Workitem",
