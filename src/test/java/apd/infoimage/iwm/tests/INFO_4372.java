...
/**
 * @author SumanGaK - 12-Jan-2018
 * INFO_4372
 * This class will create a view for workItems and validate the same in Inbox Page
 */

public class INFO_4372 extends SuperClassIWM {
	...
	public void testVerifySearchFunctionalityWithFieldValueInInbox() {
		ATUReports.setTestCaseReqCoverage("This Scenario will create view for workItems and validate the same in Inbox Page");
		ATUReports.setAuthorInfo("SumanGaK", "APR-2018", "0.3");
		try {
			Log.startTestCase("INFO_4372_VerifySearchFunctionalityWithFieldValueInInboxTest");
			Reporter.log("VerifySearchFunctionalityWithFieldValueInInboxTest : testVerifySearchFunctionalityWithFieldValueInInbox() ",	true);
			ATUReports.add("VerifySearchFunctionalityWithFieldValueInInboxTest : testVerifySearchFunctionalityWithFieldValueInInbox() ",	true);
			Log.info("VerifySearchFunctionalityWithFieldValueInInboxTest : testVerifySearchFunctionalityWithFieldValueInInbox() ");
			...
			String viewName = viewString + util.getSysDate(0, "yyDDMMhhmmss");
			...
			util.wait(time);
			// upp.selectFieldsFromAvailable("CLASS","OBJECT_ID","OBJECT_NAME");
			upp.selectFieldsFromAvailable("CLASS", "OBJECT_ID", "DOMAIN");
			...
			String column[] = { "CLASS", "OBJECT_ID", "DOMAIN" };
			...
			select.selectByVisibleText("CLASS");
			util.wait(time);

			ip.getSearchFieldInDataEntry().sendKeys(className);
			...
			Reporter.log("Verify Search Functionality With Field Value In Inbox test failed.", true);
			ATUReports.add("Verify Search Functionality With Field Value In Inbox test failed.", true);
			ATUReports.add("failed to execute test INFO_4372_VerifySearchFunctionalityWithFieldValueInInboxTest",
					LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("Verify Search Functionality With Field Value In Inbox test failed.");
		} finally {
			Log.endTestCase("INFO_4372_VerifySearchFunctionalityWithFieldValueInInboxTest");
		}
	}
}
