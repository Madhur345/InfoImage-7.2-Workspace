 ...
 * INFO_12730
 * This class verify 'Recent search' history using 'Basic search' for folder type of workitem under DOMAIN level
 */
public class INFO_12730 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testVerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevel() {

		ATUReports.setTestCaseReqCoverage("This Scenario is To verify 'Recent search' history using 'Basic search' for folder type of workitem under DOMAIN level");
		ATUReports.setAuthorInfo("Suman", "AUG-2018", "0.3");
		try {
			Log.startTestCase("INFO_12730_VerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevelTest");
			Reporter.log("INFO_12730_VerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevelTest", true);
			prop = new Properties();
			...
			Reporter.log("Class Name : INFO_12730_VerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevelTest", true);
			ATUReports.add("Class Name : INFO_12730_VerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevelTest", true);
			Log.info("Class Name : INFO_12730_VerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevelTest");
			...
			e.printStackTrace();
			Reporter.log("failed to execute VerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevel test", true);
			ATUReports.add("failed to execute VerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevel test", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("failed to execute VerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevel test");
			Log.error(e.getMessage());
		} finally {
			Log.endTestCase("INFO_12730_VerifyRecentSearchHistoryUsingBasicSearchForFolderWorkitemUnderDOMAINLevelTest");
		}
	}
