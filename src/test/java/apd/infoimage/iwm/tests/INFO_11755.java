 ...
 * adding 'tif/pdf/jpg' files for archived document type of workitem
 */
public class INFO_11755 extends SuperClassIWM{
	@BeforeMethod
	...
	public void testRefreshmentOfDocViwerByAddingTIFfileForArchivedWorkitem() {
		Log.startTestCase("INFO_11755_RefreshmentOfDocViwerByAddingTIFfileForArchivedWorkitem");
		try {
			ATUReports.setTestCaseReqCoverage(
					"This Scenario INFO-11755   Test to verify the refreshment of document viewer while "
					+ " adding 'tif/pdf/jpg' files for archived document type of workitem	 ");
			...
			Reporter.log("validation of refreshment of document viewer is successfull "
					+ "after adding TIF file to archived workitem from my personal queue", true);
			...
			Log.info("validation of refreshment of document viewer is successfull "
					+ "after adding TIF file to archived workitem from my personal queue");
			...
			Log.endTestCase("INFO_11755_RefreshmentOfDocViwerByAddingTIFfileForArchivedWorkitem");
		}
	}
}
