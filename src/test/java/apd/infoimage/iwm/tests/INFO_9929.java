 ...
 * INFO-9929
 * This class verifies Document Duplicate of Document type of Workitem and uploading file through Import
 */
public class INFO_9929 extends SuperClassIWM{
	...
	public void testVerifyDocumentWorkitemImportDocumentDuplicate(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-9929 is for Verifying Document Duplicate of Document type of Workitem and uploading file through Import");
		ATUReports.setAuthorInfo("Suman","MAR-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_9929_VerifyDocumentWorkitemImportDocumentDuplicateTest");
			...
			Reporter.log("VerifyDocumentWorkitemImportDocumentDuplicateTest",true);
			ATUReports.add("VerifyDocumentWorkitemImportDocumentDuplicateTest",true);
			Log.info("VerifyDocumentWorkitemImportDocumentDuplicateTest");
			...
			if(duplicateWorkitemPresence){
				...
				Log.info("Searching By Workitem Name In Workitem tab");
				ATUReports.add("Verify Document Duplicate of Document Workitem with Import ", "","Document Duplicate of Document Workitem with Import should be displayed",
						"Document Duplicate of Document Workitem with Import is displayed", true);
			}else{
		...
		{
			e.printStackTrace();
			Reporter.log("Verify Document Workitem Import Document Duplicate Test is failed.", true);
			ATUReports.add("Verify Document Workitem Import Document Duplicate Test is failed.",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("Verify Document Workitem Import Document Duplicate Test is failed.");
			Log.error(e.getMessage());
		}
		finally {
			Log.endTestCase("INFO_9929_VerifyDocumentWorkitemImportDocumentDuplicateTest");
		}
	}
}