...
public class INFO_10636 extends SuperClassIWM {
	@BeforeMethod
	public void setUp() {
	...
	public void testVeifySendToDefaultfunctionality() {
		Log.startTestCase("INFO_10636_verify 'Send to default' functionality  for Folder type of workitem under Actions in workitems page ");
		...
		try {
			...
			Reporter.log("verify 'Send to default' functionality  for Folder type of workitem under Actions in workitems page type test failed", true);
			ATUReports.add("verify 'Send to default' functionality  for Folder type of workitem under Actions in workitems page type test failed", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Log.info("verify 'Send to default' functionality  for Folder type of workitem under Actions in workitems page test failed");
			Assert.fail("verify 'Send to default' functionality  for Folder type of workitem under Actions in workitems page test failed");
		} finally {
			Log.endTestCase("INFO_10635_Test to verify 'Send to default' functionality  for Folder type of workitem under Actions in workitems page");
		}
	}
}
