 ...
 * INFO-12539 
 * This class verifies the scroll bar under content for single page for Unreserved document type of workitem
 */
public class INFO_12539
extends SuperClassIWM {
	...
	public void testVerifyScrollBarUnderContentForSinglePageForUnreservedDocumentWorkitem() {
		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO_12539 is for Verifying the scroll bar under content for single page for Unreserved document type of workitem");
		ATUReports.setAuthorInfo("Suman", "AUG-2018", "0.3");
		try {
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_12539_VerifyScrollBarUnderContentForSinglePageForUnreservedDocumentWorkitemTest");
			...
			Reporter.log("VerifyScrollBarUnderContentForSinglePageForUnreservedDocumentWorkitemTest", true);
			ATUReports.add("VerifyScrollBarUnderContentForSinglePageForUnreservedDocumentWorkitemTest", true);
			Log.info("VerifyScrollBarUnderContentForSinglePageForUnreservedDocumentWorkitemTest");
