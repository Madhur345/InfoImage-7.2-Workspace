 ...
 * Name Field While Performing Rename Workitem For Retrieved Folder Type Of Workitem". 27/07/2018
 */
public class INFO_11061 extends SuperClassIWM {
	...
	public void VerifyAlertMessage() {
		Log.startTestCase(
				"INFO_11061_VerifyAlertMessageAtTheTimeYouTypeANotSupportedCharacterInTheWorkitemNameFieldWhilePerformingRenameWorkitemForFolderTypeOfWorkitem");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO_11061  is To verify"
			...
			Log.endTestCase("INFO_11061_VerifyAlertMessageAtTheTimeYouTypeANotSupportedCharacterInTheWorkitemNameFieldWhilePerformingRenameWorkitemForFolderTypeOfWorkitem");
