...
/**
 * @author PradhanJ INFO-12005 To verify search criteria for one folder type of
 *         workitem using url extension in ENTERPRISE level
 */
public class INFO_12005 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testSearchOneFolderTypeWitemUsingUrlExtensionEnterpriseLevel() {
		Log.startTestCase("INFO_12005_SearchOneFolderTypeWitemUsingUrlExtensionEnterpriseLevel");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO-12005  To verify search criteria for one folder "
					+ "type of workitem using url extension in ENTERPRISE level");
			...
			Log.endTestCase("INFO_12005_SearchOneFolderTypeWitemUsingUrlExtensionEnterpriseLevel");
		}
	}
}
