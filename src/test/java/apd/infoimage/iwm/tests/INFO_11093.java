...
/**
 * @author DashBisw INFO_11093  This class is To verify 
 * "Rename The Retrieved Folder Type Of Workitem While 
...
public class INFO_11093 extends SuperClassIWM {
	...
	public void afterMethod() {
		// hp.logoutApp();
		System.err.println("Application successfully logged out");
	}
	...
	public void VerifyAlertMessage() {
		Log.startTestCase(
				"INFO_11093_VerifyRenameTheRetrievedFolderTypeOfWorkitemWhilePassingSupportedCharacterPassingInTheWorkitemNameField");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO_11092  is To verify"
					+ "Verify Rename The Retrieved Folder Type Of Workitem While Passing Supported Character Passing In The Workitem Name Field");
