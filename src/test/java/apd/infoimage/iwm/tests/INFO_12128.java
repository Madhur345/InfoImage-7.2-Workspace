 ...
 * INFO-12128
 * This class verifies deletion of multiple TIF/JPG/PNG/PDF/RTF pages asynchronously under imports for Document type of workitem
 */
public class INFO_12128 extends SuperClassIWM{
	...
	public void testVerifyDeletionOfMultiplePagesUnderImportsDocumentWorkitem(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-12128 is for Verifying deletion of Multiple TIF/JPG/PNG/PDF/RTF pages asynchronously under imports for Document type of workitem");
		ATUReports.setAuthorInfo("Suman","SEP-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_12128_VerifyDeletionOfMultiplePagesUnderImportsDocumentWorkitemTest");
			...
			Reporter.log("VerifyDeletionOfMultiplePagesUnderImportsDocumentWorkitemTest",true);
			ATUReports.add("VerifyDeletionOfMultiplePagesUnderImportsDocumentWorkitemTest",true);
			Log.info("VerifyDeletionOfMultiplePagesUnderImportsDocumentWorkitemTest");
		...
		{
			e.printStackTrace();
			Reporter.log("VerifyDeletionOfMultiplePagesUnderImportsDocumentWorkitem Test is failed.", true);
			ATUReports.add("VerifyDeletionOfMultiplePagesUnderImportsDocumentWorkitem Test is failed.",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("VerifyDeletionOfMultiplePagesUnderImportsDocumentWorkitem Test is failed.");
			Log.error(e.getMessage());
		}
		finally {
			Log.endTestCase("INFO_12128_VerifyDeletionOfMultiplePagesUnderImportsDocumentWorkitemTest");
		}
	}
