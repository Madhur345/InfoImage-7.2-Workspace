 ...
 * INFO-7515
 * This class will Perform Document Duplicate operation with different class for a document type of workitem which is retrieved from the default queue
 **/
public class INFO_7515 extends SuperClassIWM{
	...
	public void testVerifyDocumentWorkitemRetrieveFromInboxDifferentClassDocumentDuplicate(){

		ATUReports.setTestCaseReqCoverage("This Scenario INFO-7515 is for Performing Document Duplicate operation with different class for a document type of workitem which is retrieved from the default queue");
