 ...
 * @author PradhanJ
 * INFO-11788
 * Test to verify 'search workitem' tab using Domain name and modified date when
 *  workitems are searched using index field of any form by adding the url extension
 */
public class INFO_11788 extends SuperClassIWM{
	@BeforeMethod
	...
	@Test
	public void testVerifySearchWorkitemTabUsingDomainNameAndModifiedDateWhenSearchedUsingIndexFields() {
		Log.startTestCase("INFO_11788_VerifySearchWorkitemTabUsingDomainNameAndModifiedDateWhenSearchedUsingIndexFields");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO_11788  is Test to verify 'search workitem' "
					+ "tab using Domain name and modified date when workitems are searched using "
					+ "index field of any form by adding the url extension");
			...
			Log.endTestCase("INFO_11788_VerifySearchWorkitemTabUsingDomainNameAndModifiedDateWhenSearchedUsingIndexFields");
		}
	}
}
