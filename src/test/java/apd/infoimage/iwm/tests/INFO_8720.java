...
/**
 * @author PradhanJ INFO-8720 Performing 'Document split' operation by adding
 *         form fields and multpile images with different formats and different
 *         class for a document type of workitem by unchecking Retain status *
 */
public class INFO_8720 extends SuperClassIWM {
	...
	public void testDocSplitDifferentClassUncheckingRetainStatus() {
		Log.startTestCase("INFO_8720_DocSplitDifferentClassUncheckingRetainStatus");

		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-8720  is To verify 'Document split' operation by adding form fields and multpile images "
						+ "with different formats and different class for a document type of workitem by unchecking Retain status");
		...
		try {
			...
			if (addNewPageWinPresent) {
				...
				// ExcelLib.getCellValue(xlpath, sheet, 5, 1);
				...
				Reporter.log("new class name is selected in split page class dropdown	", true);
				ATUReports.add("new class name is selected in split page class dropdown", true);
			...
			ATUReports.add("Verify document Split by adding form fields and multiple pages test is failed", true);
			Assert.fail("Verify document Split by adding form fields and multiple pages test is failed");
		} finally {
			Log.endTestCase("INFO_8720_DocSplitDifferentClassUncheckingRetainStatus");
		}
	}
