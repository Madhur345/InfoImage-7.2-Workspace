...
/**
 * @author SumanGaK - 29-Aug-2018
 * INFO_12728
 * This class verify 'Recent search' history using 'Search By Name' for Folder type of workitem under ENTERPRISE level
 * Pre-requisite : Enterprise setting should be enabled in registry
 */
public class INFO_12728 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testVerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevel() {

		ATUReports.setTestCaseReqCoverage("This Scenario is To verify 'Recent search' history using 'Search By Name' for Folder type of workitem under ENTERPRISE level");
		ATUReports.setAuthorInfo("Suman", "AUG-2018", "0.3");
		try {
			Log.startTestCase("INFO_12727_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevelTest");
			Reporter.log("INFO_12727_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevelTest", true);
			prop = new Properties();
			...
			String scope = ExcelLib.getCellValue(xlpath, sheet, 81, 1);
			int time = ExcelLib.getCellValueInt(xlpath, sheet, 58, 1);

			Reporter.log("Class Name : INFO_12728_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevelTest", true);
			ATUReports.add("Class Name : INFO_12728_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevelTest", true);
			Log.info("Class Name : INFO_12728_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevelTest");
			...
			sp.getSearchByNameFolderRadio().click();
			...
			e.printStackTrace();
			Reporter.log("failed to execute VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevel test", true);
			ATUReports.add("failed to execute VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevel test", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("failed to execute VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevel test");
			Log.error(e.getMessage());
		} finally {
			Log.endTestCase("INFO_12728_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderENTERPRISELevelTest");
		}
	}	
