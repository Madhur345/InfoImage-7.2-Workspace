 ...
 * INFO-7587 
 * This class will Verify To export JPG,TIF and PDF images to multipage PDF image format from document
 * type of workitem in IWM.
 */
public class INFO_7587
extends SuperClassIWM {
	...
	public void testVerifyExportJPG_TIFAndPDFImagesToMultipagePDFImageFormatFromDocumentWorkitem() {
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-7587 is for Verifying To export JPG,TIF and PDF images to multipage PDF image format from document type of workitem in IWM");
		ATUReports.setAuthorInfo("Suman", "MAY-2018", "0.3");

		try {
			Log.startTestCase("INFO_7587_VerifyExportJPG_TIFAndPDFImagesToMultipagePDFImageFormatFromDocumentWorkitemTest");
			...
			Reporter.log("Class Name : INFO_7587_VerifyExportJPG_TIFAndPDFImagesToMultipagePDFImageFormatFromDocumentWorkitemTest",	true);
			ATUReports.add("Class Name : INFO_7587_VerifyExportJPG_TIFAndPDFImagesToMultipagePDFImageFormatFromDocumentWorkitemTest", true);
			Log.info("Class Name : INFO_7587_VerifyExportJPG_TIFAndPDFImagesToMultipagePDFImageFormatFromDocumentWorkitemTest");
			...
			Log.endTestCase("INFO_7587_VerifyExportJPG_TIFAndPDFImagesToMultipagePDFImageFormatFromDocumentWorkitemTest");
		}
	}
}
