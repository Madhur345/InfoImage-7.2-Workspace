 ...
 * INFO-7509
 * This class verifies Document Duplicate of Folder type of Workitem with index fields defined
 */
public class INFO_7509 extends SuperClassIWM{
	...
	public void testVerifyFolderWorkitemIndexFieldsDocumentDuplicate()
	{
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-7509 is for Verifying Document Duplicate of Folder type of Workitem with index fields defined");
		...
		try
		{
			...
			if(duplicateWorkitemPresence){
				...
				ATUReports.add("Verify Document Duplicate of Folder type of Workitem with index fields defined", "","Duplicate Workitem should be present in grid",
		...
		{
			e.printStackTrace();
			Reporter.log("Verify Folder Workitem Index Fields Document Duplicate Test is failed.", true);
			ATUReports.add("Verify Folder Workitem Index Fields Document Duplicate Test is failed.",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("Verify Folder Workitem Index Fields Document Duplicate Test is failed.");
		}
	}
}