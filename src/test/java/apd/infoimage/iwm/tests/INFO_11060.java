...
/**
 * @author DashBisw INFO_11060 This class is To verify "Alert Message At The
 *         Time You Type A Not Supported Character In The Workitem Name Field
 *         While Performing Rename Workitem For Folder Type Of Workitem".
 *         27/07/2018
 */
public class INFO_11060 extends SuperClassIWM {
	...
	public void VerifyAlertMessage() {
		Log.startTestCase(
				"INFO_11060_VerifyAlertMessageAtTheTimeYouTypeANotSupportedCharacterInTheWorkitemNameFieldWhilePerformingRenameWorkitemForFolderTypeOfWorkitem");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO_11060  is To verify"
					+ "Alert Message At The Time You Type A Not Supported Character In The Workitem Name Field While Performing Rename Workitem For Folder Type Of Workitem");
			...
			ATUReports.add(
					"Verify Alert Message At The Time You Type A Not Supported Character In The Workitem Name Field While Performing Rename Workitem For Folder Type Of Workitem",
