...
public class INFO_10661 extends SuperClassIWM {
	@BeforeMethod
	public void setUp() {
	...
	public void VerifyReturntoQueuFunctionalityForFolderTypeOfWorkitem() {
		Log.startTestCase("INFO_10661_VerifyReturntoQueuFunctionalityForWorkitemOfDocumentType");
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-10674 is for verify 'Return to Queue' functionality for Document  type of workitem");
		...
		try {
			...
			Reporter.log("VerifyReturntoQueuFunctionalityForWorkitemOfDocumentTypeTest", true);
			ATUReports.add("VerifyReturntoQueuFunctionalityForWorkitemOfDocumentTypeTest", true);
			Log.info("VerifyReturntoQueuFunctionalityForWorkitemOfDocumentTypeTest");
			...
			Reporter.log("verify 'Return to Queue' functionality for  Document  type of workitem type test failed", true);
			ATUReports.add(" verify 'Return to Queue' functionality for  Document  type of workitem test failed",
					LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Log.info(" verify 'Return to Queue' functionality for Document type of workitem type test failed");
			Assert.fail(" verify 'Return to Queue' functionality for Document  type of workitem type test failed");
		}

		finally {
			Log.endTestCase("INFO_10661_VerifyReturntoQueuFunctionalityForWorkitemOfDocumentType");
		}
	}
