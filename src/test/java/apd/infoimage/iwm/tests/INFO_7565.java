...
/**
 * @author SinghAvn
 * @Zypher Id: INFO-7565 This Scenario is exporting PDF image to JPEG format
 *         from document type of workitem in IWM
 *
 */
public class INFO_7565 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testexportPDFtoJPEGformat() {
		...
		try {
			...
			Log.endTestCase(
					"INFO-7565 This Scenario is exporting PDF image to JPEG format from document type of workitem in IWM");
		}
	}
}
