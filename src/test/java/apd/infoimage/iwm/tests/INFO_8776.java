 ...
 * @author PradhanJ
 * INFO-8776
 * This class will perform 'Auto view' functionality for multiple workitems from any queue
 */

public class INFO_8776 extends SuperClassIWM{
	...
	{
		Log.startTestCase("INFO_8776_PerformAutoViewForMultipleWitemsAnyQueue");
		try
		{
			ATUReports.setTestCaseReqCoverage("This Scenario INFO-8776  is for Performing "
					+ "'Auto view' functionality for multiple workitems from any queue");
			...
			ATUReports.add("Send all opened workitems to default queue","","All workitems should be sent to default queue", 
			...
			e.printStackTrace();			
			ATUReports.add("Failed to perform  Auto view functionality for multiple workitems from any queue", 
					LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("Failed to perform Auto view' functionality for multiple workitems from any queue");
			
		}
		finally {
			Log.endTestCase("INFO_8776_PerformAutoViewForMultipleWitemsAnyQueue");
