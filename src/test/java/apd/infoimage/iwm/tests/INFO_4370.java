 ...
 * INFO_4370
 * This class verify the search functionality with IDCODE value in workitems page.
 */

public class INFO_4370 extends SuperClassIWM{
	...
	public void testVerifySearchFunctionalityWithIDCODEValueInWorkitems()
	{
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-4370 is for Verifying search functionality with IDCODE value in workitems page");
		ATUReports.setAuthorInfo("Suman","MAY-2018","0.3");

		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_4370_VerifySearchFunctionalityWithIDCODEValueInWorkitemsTest");
			prop = new Properties();
			...
			Reporter.log("INFO_4370_VerifySearchFunctionalityWithIDCODEValueInWorkitemsTest ",true);
			...
			cwp.getNameSearchTextbox().sendKeys(idCodeStr+Keys.ENTER);
			...
			if(workitemPresence){
				...
				ATUReports.add("Verify SearchFunctionalityWithIDCODEValueInWorkitems Test", "","SearchFunctionalityWithIDCODEValueInWorkitems should be displayed",
						"SearchFunctionalityWithIDCODEValueInWorkitems is displayed", true);
			}else{
		...
		catch(Exception e)
		{
			...
			Reporter.log("Verify Search Functionality With IDCODE Value In Workitems test failed.", true);
			Assert.fail("Verify Search Functionality With IDCODE Value In Workitems test failed.");
		}
		finally {
			Log.endTestCase("INFO_4370_VerifySearchFunctionalityWithIDCODEValueInWorkitemsTest");
		}
	}
}