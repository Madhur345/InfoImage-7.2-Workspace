 ...
 * @author SumanGaK
 * INFO-12733
 * This class is used to verify 'Recent search' history using 'Nested search' for document type of workitem
 */
public class INFO_12733 extends SuperClassIWM{
	@BeforeMethod
	public void setUp() {
		Driver.driver.get(prop.getProperty("appUrl"));
		util.waitForPageToLoad();
		lp.loginToApp("userName11", "password", "domain", "role9");
		util.waitForPageToLoad();
	}
	...
	public void testVerifyRecentSearchHistoryUsingNestedSearchForDocumentWorkitem() {
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-12733 is Test to verify 'Recent search' history using 'Nested search' for document type of workitem");
		ATUReports.setAuthorInfo("Suman", "AUG-2018", "0.3");

		try {
			Log.startTestCase("INFO_12733_VerifyRecentSearchHistoryUsingNestedSearchForDocumentWorkitemTest");
			...
			Reporter.log("Class Name : INFO_12733_VerifyRecentSearchHistoryUsingNestedSearchForDocumentWorkitemTest", true);
			ATUReports.add("Class Name : INFO_12733_VerifyRecentSearchHistoryUsingNestedSearchForDocumentWorkitemTest", true);
			Log.info("Class Name : INFO_12733_VerifyRecentSearchHistoryUsingNestedSearchForDocumentWorkitemTest");
			...
			Reporter.log("History Of Nested Search is clicked", true);
			ATUReports.add("History Of Nested Search is clicked", true);
			Log.info("History Of Nested Search is clicked");
			...
			e.printStackTrace();
			Reporter.log("failed to execute VerifyRecentSearchHistoryUsingNestedSearchForDocumentWorkitem test", true);
			ATUReports.add("failed to execute VerifyRecentSearchHistoryUsingNestedSearchForDocumentWorkitem test", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("failed to execute VerifyRecentSearchHistoryUsingNestedSearchForDocumentWorkitem test");
			Log.error(e.getMessage());
		} finally {
			Log.endTestCase("INFO_12733_VerifyRecentSearchHistoryUsingNestedSearchForDocumentWorkitemTest");
		}
	}
}