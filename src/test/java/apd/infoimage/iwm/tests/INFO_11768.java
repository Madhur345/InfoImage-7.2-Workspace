...
/**
 * @author PradhanJ INFO-11768 To verify search criteria for one document type
 *         of workitem using url extension in DOMAIN level
 */
public class INFO_11768 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testSearchOneDocumentTypeWitemUsingUrlExtensionDomainLevel() {
		Log.startTestCase("INFO_11768_SearchOneDocumentTypeWitemUsingUrlExtensionDomainLevel");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO-11768   To verify search criteria for one "
					+ "document type of workitem using url extension in DOMAIN level	 ");
			...
			Log.endTestCase("INFO_11768_SearchOneDocumentTypeWitemUsingUrlExtensionDomainLevel");
		}
	}
}
