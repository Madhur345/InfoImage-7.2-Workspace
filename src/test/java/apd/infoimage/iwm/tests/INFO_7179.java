 ...
 * @author PradhanJ
 * INFO-7189
 * To export PNG image as PDF format from document type of workitem in IWM
 */
public class INFO_7179 extends SuperClassIWM {
	...
	public void testExportPNGImageAsPDFFromDocTypeWorkitem() {

		Log.startTestCase("INFO_7179_ExportPNGImageAsPDFFromDocTypeWorkitem");

		ATUReports.setTestCaseReqCoverage(
				"INFO-7179 This Scenario is To export PNG image as PDF format from document type of workitem in IWM");
		...
		try {
			...
			e.printStackTrace();
			Reporter.log("Exporting PNG image to PDF format from document type of workitem is failed.", true);
			ATUReports.add("Exporting PNG image to PDF format from document type of workitem is failed", LogAs.FAILED,
					new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("Exporting PNG image to PDF format from document type of workitem is failed.");
			Log.error(e.getMessage());
		} finally {
			Log.endTestCase("INFO_7179_ExportPNGImageAsPDFFromDocTypeWorkitem");
