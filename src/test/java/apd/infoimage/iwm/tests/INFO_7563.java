...
/**
 * @author SinghAvn
 * @Zypher Id: INFO-7563 This Scenario To export PDF image to PDF format from
 *         document type of workitem in IWM
 *
 */
public class INFO_7563 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testexportPDFtoPDFformat() {

		String workitem = "wi" + util.getSysDate(0, "yyDDMMhhmmss");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase(
				"INFO-7560 This Scenario will export PDF image to PDF format from document type of workitem in IWM");
		...
		try {
			...
			if (addNewPageWinPresent) {
				...
				Reporter.log("PDF checkbox is checked", true);
				ATUReports.add("PDF checkbox is checked", true);
				Log.info("PDF checkbox is checked");
			...
			Log.endTestCase("INFO-7563 export PDF to PDF format from document type of workitem in IWM is Failed");
		}
	}
}
