 ...
 * INFO-12502
 * This class verifies the scroll bar under content for Fifteen Pages for document type of workitem
 */
public class INFO_12502 extends SuperClassIWM{
	...
	public void testVerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitem(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO_12502 is for Verifying the scroll bar under content for Fifteen Pages for document type of workitem");
		ATUReports.setAuthorInfo("Suman","SEP-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_12502_VerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitemTest");
			...
			Reporter.log("VerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitemTest",true);
			ATUReports.add("VerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitemTest",true);
			Log.info("VerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitemTest");
		...
		catch(Exception e)
		{
			...
			Reporter.log("VerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitemTest test is failed", true);
			Log.info("VerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitemTest is failed");
			ATUReports.add("VerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitemTest is failed",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("VerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitemTest is failed");		
		}		
		finally {
			Log.endTestCase("INFO_12502_VerifyScrollBarUnderContentForFifteenPagesForDocumentWorkitemTest");
		}
	}
