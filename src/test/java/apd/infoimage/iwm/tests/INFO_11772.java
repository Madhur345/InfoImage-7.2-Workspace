 ...
 * @author PradhanJ
 * INFO-11772
 * To verify search criteria for multiple folder type of workitems using url extension in DOMAIN level
 */
public class INFO_11772 extends SuperClassIWM{
	@BeforeMethod
	...
	public void testSearchMultipleFolderTypeDomainLevelUsingUrlExtension() {
		Log.startTestCase("INFO_11772_SearchMultipleFolderTypeDomainLevelUsingUrlExtension");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO-11772   To verify search criteria for multiple "
					+ "folder type of workitems using url extension in DOMAIN level ");
			...
			Reporter.log("Search for multiple folder type workitems validation failed"
					+ "using Url extenxion in Domain Level", true);
			ATUReports.add(
					"Search for multiple folder type workitems validation failed"
							+ "using Url extenxion in Domain Level",
					LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("Search for multiple folder type workitems validation failed"
					+ "using Url extenxion in Domain Level");
		} finally {
			Log.endTestCase("INFO_11772_SearchMultipleFolderTypeDomainLevelUsingUrlExtension");
		}
	}
}
