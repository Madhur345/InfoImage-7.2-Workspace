 ...
 * INFO-12129
 * This class verifies deletion of multiple TIF/JPG/PNG/PDF/RTF pages asynchronously under imports for folder type of workitem
 */
public class INFO_12129 extends SuperClassIWM{
	...
	public void testVerifyDeletionOfMultiplePagesUnderImportsFolderWorkitem(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-12129 is for Verifying deletion of Multiple TIF/JPG/PNG/PDF/RTF pages asynchronously under imports for folder type of workitem");
		ATUReports.setAuthorInfo("Suman","SEP-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_12129_VerifyDeletionOfMultiplePagesUnderImportsFolderWorkitemTest");
			...
			Reporter.log("VerifyDeletionOfMultiplePagesUnderImportsFolderWorkitemTest",true);
			ATUReports.add("VerifyDeletionOfMultiplePagesUnderImportsFolderWorkitemTest",true);
			Log.info("VerifyDeletionOfMultiplePagesUnderImportsFolderWorkitemTest");
		...
		{
			e.printStackTrace();
			Reporter.log("VerifyDeletionOfMultiplePagesUnderImportsFolderWorkitem Test is failed.", true);
			ATUReports.add("VerifyDeletionOfMultiplePagesUnderImportsFolderWorkitem Test is failed.",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("VerifyDeletionOfMultiplePagesUnderImportsFolderWorkitem Test is failed.");
			Log.error(e.getMessage());
		}
		finally {
			Log.endTestCase("INFO_12129_VerifyDeletionOfMultiplePagesUnderImportsFolderWorkitemTest");
		}
	}
