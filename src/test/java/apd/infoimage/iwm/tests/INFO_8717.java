...
/**
 * @author Biswajit INFO-8717 Performing 'Document split' operation by adding
 *         form fields and multpile images with different formats and same class
 *         for a document type of workitem.
 */
public class INFO_8717 extends SuperClassIWM {
	...
	public void testDocSplitSameClass() {
		Log.startTestCase(
				"INFO_8717_PerformingDocumentSplitOperationByAddingFormFieldsAndMultpileImagesWithDifferentFormatsAndSameClassForADocumentTypeofWorkitem");

		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-8717  is To verify 'Document split' operation by adding form fields and multpile images "
