 ...
 * INFO-12133
 * This class verifies deletion of multiple TIF/JPG/PNG/PDF/RTF pages asynchronously under imports when one import is open for Document type of workitem
 */
public class INFO_12133 extends SuperClassIWM{
	...
	public void testVerifyDeletionOfMultiplePagesUnderImportsWhenOneImportIsOpenForDocumentWorkitem(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-12133 is for Verifying deletion of Multiple TIF/JPG/PNG/PDF/RTF pages asynchronously under imports when one import is open for Document type of workitem");
		ATUReports.setAuthorInfo("Suman","SEP-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_12133_VerifyDeletionOfMultiplePagesUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest");
			...
			Reporter.log("VerifyDeletionOfMultiplePagesUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest",true);
			ATUReports.add("VerifyDeletionOfMultiplePagesUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest",true);
			Log.info("VerifyDeletionOfMultiplePagesUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest");
		...
		{
			e.printStackTrace();
			Reporter.log("VerifyDeletionOfMultiplePagesUnderImportsWhenOneImportIsOpenForDocumentWorkitem Test is failed.", true);
			ATUReports.add("VerifyDeletionOfMultiplePagesUnderImportsWhenOneImportIsOpenForDocumentWorkitem Test is failed.",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("VerifyDeletionOfMultiplePagesUnderImportsWhenOneImportIsOpenForDocumentWorkitem Test is failed.");
			Log.error(e.getMessage());
		}
		finally {
			Log.endTestCase("INFO_12133_VerifyDeletionOfMultiplePagesUnderImportsWhenOneImportIsOpenForDocumentWorkitemTest");
		}
	}	
}
