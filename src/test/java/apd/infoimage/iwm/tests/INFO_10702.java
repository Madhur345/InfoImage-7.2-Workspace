...
public class INFO_10702 extends SuperClassIWM {
	...
	public void VerifyDuplicateButtonDisabled() {
		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-10702 is for Duplicate button should be disabled after clicking on Duplicate for folder type of workitem in workitems page");
		...
		try {
			...
			Reporter.log("Idcode has been written to the field", true);
		...
		Exception e) {
			e.printStackTrace();
			Reporter.log("Verify Duplicate button should be disabled after clicking on Duplicate for folder type of workitem in workitems page", true);
			ATUReports.add("Verify Duplicate button should be disabled after clicking on Duplicate for folder type of workitem in workitems page is failed.", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Log.info("Verify Duplicate button should be disabled after clicking on Duplicate for folder type of workitem in workitems page");
			Assert.fail("Verify Duplicate button should be disabled after clicking on Duplicate for folder type of workitem in workitems page is failed.");
		}

		finally {
			Log.endTestCase("INFO-10702_Duplicate button should be disabled after clicking on Duplicate for folder type of workitem in workitems page is Failed");
		}
