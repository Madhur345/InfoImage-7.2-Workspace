 ...
 */
public class INFO_12009 extends SuperClassIWM{
	@BeforeMethod
	...
	public void testVerifySearchMultipleWitemsDocTypeEnterpriseLevelUsingUrlExtension()
	{
		Log.startTestCase("INFO_12009_VerifySearchMultipleWitemsDocTypeEnterpriseLevelUsingUrlExtension");
		try
		{
			ATUReports.setTestCaseReqCoverage("This Scenario INFO-12009  To verify search criteria for multiple "
					+ "document type of workitems present "
					+ "in the queue using url extension in ENTERPRISE level	 ");
			...
			Log.endTestCase("INFO_12009_VerifySearchMultipleWitemsDocTypeEnterpriseLevelUsingUrlExtension");
		}
	}
}
