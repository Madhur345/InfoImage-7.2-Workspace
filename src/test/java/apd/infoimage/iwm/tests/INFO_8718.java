...
/**
 * @author Biswajit INFO-8718 Performing 'Document split' operation by adding
 *         form fields and multpile images with different formats and different
 *         class for a document type of workitem.
 */
public class INFO_8718 extends SuperClassIWM {
	...
	public void testDocSplitMultpileImagesWithDifferentFormatsAndDifferentClassForADocumentTypeofWorkitem() {
		Log.startTestCase(
				"INFO_8718_PerformingDocumentSplitOperationByAddingFormFieldsAndMultpileImagesWithDifferentFormatsAndDifferentClassForADocumentTypeofWorkitem");

		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-8718  is To verify 'Document split' operation by adding form fields and multpile images "
		...
		try {
			...
			ATUReports.add("Verify document Split by adding form fields and multiple pages test is failed",
