...
/**
 * @author DashBisw INFO_11067 This class is To verify "No Alert Message At The
 *         Time You Type A Supported Character In The Workitem Name Field While
 *         Performing Rename Workitem For Retrieved Folder Type Of Workitem".
 *         30/07/2018
 */
public class INFO_11067 extends SuperClassIWM {
	...
	public void VerifyAlertMessage() {
		Log.startTestCase(
				"INFO_11067_VerifyNoAlertMessageAtTheTimeYouTypeASupportedCharacterInTheWorkitemNameFieldWhilePerformingRenameWorkitemForRetrivedFolderTypeOfWorkitem");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO_11067  is To verify"
					+ "Alert Message At The Time You Type A Supported Character In The Workitem Name Field While Performing Rename Workitem For Retrived Folder Type Of Workitem");
			...
			ATUReports.add(
					"Verify No Alert Message At The Time You Type A Supported Character In The Workitem Name Field While Performing Rename Workitem For retrived Folder Type Of Workitem",
