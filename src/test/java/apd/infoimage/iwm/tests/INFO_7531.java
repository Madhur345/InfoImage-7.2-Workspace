 ...
 * INFO-7531
 * This class will Verify Document Duplicate operation with different class for a document type of workitem where a page is copied in one workitem and duplicate copy of the same page will be copied to another workitem
 **/
public class INFO_7531 extends SuperClassIWM{
	...
	public void testVerifyDocumentWorkitemPageCopiedWithDuplicateCopyOfPageCopiedToAnotherWorkitemDifferentClassDocumentDuplicate()
	{
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-7531 is for Performing Document Duplicate operation with different class for a document type of workitem where a page is copied in one workitem and duplicate copy of the same page will be copied to another workitem");
		ATUReports.setAuthorInfo("Suman","JUN-2018","0.3"); 

		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_7531_VerifyDocumentWorkitemPageCopiedWithDuplicateCopyOfPageCopiedToAnotherWorkitemDifferentClassDocumentDuplicateTest");
			prop = new Properties();
			...
			Reporter.log("Class Name : INFO_7531_VerifyDocumentWorkitemPageCopiedWithDuplicateCopyOfPageCopiedToAnotherWorkitemDifferentClassDocumentDuplicateTest",true);
			ATUReports.add("Class Name : INFO_7531_VerifyDocumentWorkitemPageCopiedWithDuplicateCopyOfPageCopiedToAnotherWorkitemDifferentClassDocumentDuplicateTest",true);
			Log.info("Class Name : INFO_7531_VerifyDocumentWorkitemPageCopiedWithDuplicateCopyOfPageCopiedToAnotherWorkitemDifferentClassDocumentDuplicateTest");
			...
			if(addNewPageWinPresent) {
				...
				Reporter.log("New Workitem : "+newWorkitem,true);
				ATUReports.add("New Workitem : "+newWorkitem,true);
				Log.info("New Workitem : "+newWorkitem);
				Reporter.log("Class Name : "+className,true);
				ATUReports.add("Class Name : "+className,true);
				Log.info("Class Name : "+className);
				Reporter.log("Workitem Type : "+workitemType,true);
				...
				cwp.CreateWorkitem(newWorkitem,className,workitemType);

				Reporter.log("CreateWorkitem operation performed",true);
				ATUReports.add("CreateWorkitem operation performed",true);
				Log.info("CreateWorkitem operation performed");
				Reporter.log("Document: "+newWorkitem+" has been created",true);
				ATUReports.add("Document: "+newWorkitem+" has been created",true);
				...
				cwp.getWorkItemName(newWorkitem).click();
				util.wait(time);
				util.waitForPageToLoad();
				Reporter.log("WorkItem is clicked",true);
				ATUReports.add("WorkItem is clicked",true);
		...
		{
			e.printStackTrace();
			Reporter.log("VerifyDocumentWorkitemPageCopiedWithDuplicateCopyOfPageCopiedToAnotherWorkitemDifferentClassDocumentDuplicateTest is failed.", true);
			ATUReports.add("VerifyDocumentWorkitemPageCopiedWithDuplicateCopyOfPageCopiedToAnotherWorkitemDifferentClassDocumentDuplicateTest is failed.",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("VerifyDocumentWorkitemPageCopiedWithDuplicateCopyOfPageCopiedToAnotherWorkitemDifferentClassDocumentDuplicateTest is failed.");
		}
		finally
		{
			Log.endTestCase("INFO_7531_VerifyDocumentWorkitemPageCopiedWithDuplicateCopyOfPageCopiedToAnotherWorkitemDifferentClassDocumentDuplicateTest");
		}
	}
}