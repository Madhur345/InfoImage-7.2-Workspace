...
/**
 * @author SumanGaK - 31-May-2018
 * INFO_8714
 * This class Perform Document split operation using multiple images with Different format , DifferentClass and File Document To Folder Workitem 
 */
public class INFO_8714 extends SuperClassIWM {
	...
	public void testPerformingDocumentSplitMultipleImagesWithDifferentFormatDifferentClassFileDocumentToFolderWorkitem() {
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-8714 is for Performing Document split operation using multiple images with Different format , DifferentClass and File Document To Folder Workitem");
		ATUReports.setAuthorInfo("Suman","MAY-2018","0.3"); 

		try {
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_8714_PerformingDocumentSplitMultipleImagesWithDifferentFormatDifferentClassFileDocumentToFolderWorkitemTest");
			...
			if (contentListSplitted == numberOne) {
				...
				ATUReports.add("Verify document Split by adding multiple pages and Different class test is successfull", true);
			} else {
			...
			if (contentListInSecondSplitted == numberTwo) {
				...
				Log.info("Verify document Split by adding form fields and multiple pages test is successful");
			} else {
		...
		catch(Exception e)
		{
			...
			Log.endTestCase("INFO_8714_PerformingDocumentSplitMultipleImagesWithDifferentFormatDifferentClassFileDocumentToFolderWorkitem");
		}
	}	
}