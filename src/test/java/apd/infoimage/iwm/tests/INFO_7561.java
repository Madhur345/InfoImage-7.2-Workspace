...
/**
 * @author SinghAvn
 * @Zypher Id: INFO-7561 This Scenario will export TIF image to BMP format from
 *         document type of workitem in IWM.
 */
public class INFO_7561 extends SuperClassIWM {
	...
	public void testSameWorkIteminUserQueue() {
		...
		Log.startTestCase(
				"INFO-7561 This Scenario will export TIF image to BMP format from document type of workitem in IWM");
		...
		try {
			...
			if (addNewPageWinPresent) {
				...
				Reporter.log("clicked on BMP checkbox", true);
				ATUReports.add("clicked on BMP checkbox", true);
				Log.info("clicked on BMP checkbox");
			...
			Log.endTestCase("INFO-7560 export TIF image to BMP format from document type of workitem is Failed");
		}
	}
