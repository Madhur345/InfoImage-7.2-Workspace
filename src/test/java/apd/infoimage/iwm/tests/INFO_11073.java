...
/**
 * @author DashBisw INFO_11073 This class is To verify "Warning Message While
 *         Performing Rename Workitem Functionality With UnSupported Character
 *         In The Workiitem Name Field For Documnet Type Of Workitem. 01/08/2018
 */
public class INFO_11073 extends SuperClassIWM {
	...
	@Test
	public void VerifyWarningtMessage() {
		Log.startTestCase(
				"INFO_11073_VerifyWarningMessageWhilePerformingRenameWorkitemFunctionalityWithUnSupportedCharacterInTheWorkiitemNameFieldForDocumnetTypeOfWorkitem");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO_11073  is To verify"
					+ "Warning Message While Performing Rename Workitem Functionality With UnSupported Character In The Workiitem Name Field For Documnet Type Of Workitem");
			...
			ATUReports.add(
					"Verify Warning Message While Performing Rename Workitem Functionality With UnSupported Character In The Workiitem Name Field For Documnet Type Of Workitem",
