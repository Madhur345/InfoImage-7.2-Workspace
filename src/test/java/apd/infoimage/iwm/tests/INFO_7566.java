...
/**
 * @author SinghAvn
 * @Zypher Id: INFO-7566 This Scenario is exporting PDF image to JPG format from
 *         document type of workitem in IWM
 *
 */
public class INFO_7566 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testexportPDFtoJPGformat() {

		String workitem = "wi" + util.getSysDate(0, "yyDDMMhhmmss");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase(
				"INFO-7564 This Scenario is exporting PDF image to PNG format from document type of workitem in IWM");
		...
		try {
			...
			Log.endTestCase(
					"INFO-7566 This Scenario is exporting PDF image to JPG format from document type of workitem in IWM");
		}
	}
}
