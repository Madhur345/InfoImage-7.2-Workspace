...
/**
 * @author DashBisw INFO_11069  This class is To verify 
 * "No Alert Message At The Time You Type A Supported Character In The Workitem 
 * Name Field While Performing Rename Workitem For Retrieved Document Type Of Workitem". 30/07/2018
 */
public class INFO_11069 extends SuperClassIWM {
	...
	public void afterMethod() {
		Log.endTestCase(
				"INFO_11069_VerifyNoAlertMessageAtTheTimeYouTypeASupportedCharacterInTheWorkitemNameFieldWhilePerformingRenameWorkitemForRetrivedDocumentTypeOfWorkitem");
	}
	...
	public void VerifyAlertMessage() {
		Log.startTestCase(
				"INFO_11069_VerifyNoAlertMessageAtTheTimeYouTypeASupportedCharacterInTheWorkitemNameFieldWhilePerformingRenameWorkitemForRetrivedDocumentTypeOfWorkitem");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO_11069  is To verify"
					+ "Alert Message At The Time You Type A Supported Character In The Workitem Name Field While Performing Rename Workitem For Retrived Document Type Of Workitem");
			...
			Log.info("workitem Created successfully");
			Thread.sleep(5000);
			...
			ATUReports.add(
					"Verify No Alert Message At The Time You Type A Supported Character In The Workitem Name Field While Performing Rename Workitem For retrived Document Type Of Workitem",
