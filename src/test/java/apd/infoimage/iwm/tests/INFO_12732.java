...
/**
 * @author SumanGaK - 5-Sep-2018
 * INFO_12732
 * This class verify 'Recent search' history using 'Search By Name' for Folder type of workitem under Archive level
 * Pre-requisite : Archive setting should be enabled in registry
 */
public class INFO_12732 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testVerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevel() {

		ATUReports.setTestCaseReqCoverage("This Scenario is To verify 'Recent search' history using 'Search By Name' for Folder type of workitem under Archive level");
		ATUReports.setAuthorInfo("Suman", "SEP-2018", "0.3");
		try {
			Log.startTestCase("INFO_12732_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevelTest");
			Reporter.log("INFO_12732_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevelTest", true);
			prop = new Properties();
			...
			Reporter.log("Class Name : INFO_12732_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevelTest", true);
			ATUReports.add("Class Name : INFO_12732_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevelTest", true);
			Log.info("Class Name : INFO_12732_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevelTest");
			...
			e.printStackTrace();
			Reporter.log("failed to execute VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevel test", true);
			ATUReports.add("failed to execute VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevel test", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("failed to execute VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevel test");
			Log.error(e.getMessage());
		} finally {
			Log.endTestCase("INFO_12732_VerifyRecentSearchHistoryUsingSearchByNameForFolderWorkitemUnderArchiveLevelTest");
		}
	}	
