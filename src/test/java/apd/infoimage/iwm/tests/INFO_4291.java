 ...
 * @author PradhanJ
 * INFO-4291
 * Test to verify the Nested search functionality using Refined search in iwm.
 */
public class INFO_4291 extends SuperClassIWM{
	...
	public void testVerifyNestedSearchUsingRefinedSearch() {
		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-4291 is Test to verify verify the Nested search "
				+ "functionality using Refined search in iwm");
		ATUReports.setAuthorInfo("Jayashri", "JUNE-2018", "0.3");

		try {
			Log.startTestCase(
					"INFO_4291_VerifyNestedSearchUsingRefinedSearch");
			...
			if(f9){
				Reporter.log("Workitem is searched successfully by using query in refined search",true);
				ATUReports.add("Workitem is searched successfully by using query in refined search", true);
				Log.info("Workitem is searched successfully by using query in refined search");
			}else{
				ATUReports.add("Nested query validation in Refined search test failed", 
			...
			Log.endTestCase("INFO_4291_VerifyNestedSearchUsingRefinedSearch");
