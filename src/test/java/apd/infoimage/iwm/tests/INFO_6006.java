...
public class INFO_6006 extends SuperClassIWM {
	...
	public void performReclassifyWithSaveOptionWithoutRetainingData(){
		...
		try{
			...
			*/
			...
			Log.endTestCase("INFO_6006_Reclassify");
		}
	}
	
	@Test(enabled =false,groups={"WorkitemDetailView"})
