 ...
 * INFO-12538
 * This class verifies the scroll bar under content for Greater Than Fifteen Pages for document type of workitem which is filed inside folder
 */
public class INFO_12538 extends SuperClassIWM{
	...
	public void testVerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolder(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO_12538 is for Verifying the scroll bar under content for Greater Than Fifteen Pages for document type of workitem which is filed inside folder");
		ATUReports.setAuthorInfo("Suman","SEP-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_12538_VerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolderTest");
			...
			Reporter.log("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolderTest",true);
			ATUReports.add("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolderTest",true);
			Log.info("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolderTest");
		...
		catch(Exception e)
		{
			...
			Reporter.log("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolder test is failed", true);
			Log.info("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolder test is failed");
			ATUReports.add("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolder test is failed",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolder test is failed");		
		}		
		finally {
			Log.endTestCase("INFO_12538_VerifyScrollBarUnderContentForGreaterThanFifteenPagesForDocumentWorkitemFiledInsideFolderTest");
		}
	}
}