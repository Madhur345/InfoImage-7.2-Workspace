...
public class INFO_10638 extends SuperClassIWM {
	@BeforeMethod
	public void setUp() {
	...
	public void testVeifySendToDefaultfunctionality() {
		Log.startTestCase("INFO_10638_ Test to verify 'Send to default' functionality for multiple times for folder type of workitem under Actions in workitems pagepage ");
		ATUReports.setTestCaseReqCoverage("This Scenario will Test to  verify  "
				+ " 'Send to default' functionality  for folder type of workitem under Actions in workitems page");
		...
		try {
			...
			if(workitemPresence){
				...
				ATUReports.add("verify 'Send to default' functionality for multiple times for folder type of workitem under Actions in workitems page Test", "","Workitem should be displayed",
			...
			Reporter.log("verify 'Send to default' functionality for multiple times for folder type of workitem under Actions in workitems page type test failed", true);
			ATUReports.add(" verify 'Send to default' functionality for multiple times for folder type of workitem under Actions in workitems page type test failed", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Log.info("verify 'Send to default' functionality for multiple times for folder type of workitem under Actions in workitems page type test failed");
			Assert.fail("verify 'Send to default' functionality for multiple times for folder type of workitem under Actions in workitems page type test failed");
		} finally {
			Log.endTestCase("INFO_10638_verify 'Send to default' functionality for multiple times for folder type of workitem under Actions in workitems");
		}
	}
}
