...
/**
 * @author DashBisw INFO-8760 This Class is Performing Auto View Functionality
 *         For Multiple Workitems In Mutilpe Queues. 10/05/2018
 */

public class INFO_8760 extends SuperClassIWM {
	...
	public void performingGetNextfunctionalityforMultipleWorkitemsInAnyQueueByOpeningOneWorkitemInTheQueue() {
		Log.startTestCase("INFO_8760_PerformingAutoViewFunctionalityForMultipleWorkitemsInMutilpeQueues");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO-8760  is To verify"
					+ " Performing Auto View Functionality For Multiple Workitems In Mutilpe Queues");
			...
			ATUReports.add("Performing Auto View Functionality For Multiple Workitems In Mutilpe Queues", LogAs.FAILED,
			...
			Log.endTestCase("INFO_8760_PerformingAutoViewFunctionalityForMultipleWorkitemsInMutilpeQueues");
