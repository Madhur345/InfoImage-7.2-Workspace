 ...
 * @author PradhanJ
 * INFO-12006
 * To verify search criteria for multiple folder type of workitems using url extension in ENTERPRISE levels
 */
public class INFO_12006 extends SuperClassIWM{
	@BeforeMethod
	...
	public void testSearchMultipleFolderTypeWitemsUsingUrlExtensionEnterpriseLevel()
	{
		Log.startTestCase("INFO_12006_SearchMultipleFolderTypeWitemsUsingUrlExtensionEnterpriseLevel");
		try
		{
			ATUReports.setTestCaseReqCoverage("This Scenario INFO-12006  To verify search criteria for multiple "
					+ "folder type of workitems using url extension in ENTERPRISE levels");
			...
			Log.endTestCase("INFO_12006_SearchMultipleFolderTypeWitemsUsingUrlExtensionEnterpriseLevel");
		}
	}
}
