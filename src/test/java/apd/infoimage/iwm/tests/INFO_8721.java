...
/**
 * @author PradhanJ INFO-8721 Performing multiple 'Document splits' operation
 *         using multpile images with different formats and same class for a
 *         document type of workitem
 * 
 */
public class INFO_8721 extends SuperClassIWM {
	...
	public void testDocSplitUsingMultipleImagesForSameClass() {
		Log.startTestCase("INFO_8721_DocSplitUsingMultipleImagesForSameClass");

		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-9421  is To verify 'Document split' operation using multpile images "
		...
		try {
			...
			Reporter.log(
					"Verify document Split by adding multiple pages with different format and same class name test is failed",
					true);
			ATUReports.add(
					"Verify document Split by adding multiple pages with different format and same class name test is failed",
					true);
			...
			Log.endTestCase("INFO_8721_DocSplitUsingMultipleImagesForSameClass");
		}
	}
