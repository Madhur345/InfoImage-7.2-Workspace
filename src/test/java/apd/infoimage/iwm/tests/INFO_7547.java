 ...
 * INFO-7547 
 * This class verifies Document Duplicate of Document type of Workitem with index fields defined And Auto Open
 */
public class INFO_7547 extends SuperClassIWM {
	...
	public void testVerifyDocumentWorkitemIndexFieldsFormDataAutoOpenDocumentDuplicate() {
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-7547 is for Verifying Document Duplicate of Document type of Workitem with index fields defined And Auto Open");
		...
		try {
			...
			Reporter.log("VerifyDocumentWorkitemIndexFieldsFormDataAutoOpenDocumentDuplicateTest", true);
			ATUReports.add("VerifyDocumentWorkitemIndexFieldsFormDataAutoOpenDocumentDuplicateTest", true);
			Log.info("VerifyDocumentWorkitemIndexFieldsFormDataAutoOpenDocumentDuplicateTest");
			...
			if (duplicateWorkitemPresence) {
				...
				ATUReports.add("Verify Document Workitem Index Fields Document Duplicate Test", "",
						"Document Duplicate of Document type of Workitem with index fields defined And Auto Open should be displayed",
						"Document Duplicate of Document type of Workitem with index fields defined And Auto Open is displayed",
						true);
			...
			Reporter.log("Verify Document Workitem Index Fields Document Duplicate Test is failed.", true);
			ATUReports.add("Verify Document Workitem Index Fields Document Duplicate Test is failed.", LogAs.FAILED,
					new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("Verify Document Workitem Index Fields Document Duplicate Test is failed.");
		}
		finally {
			Log.endTestCase("INFO_7547_VerifyDocumentWorkitemIndexFieldsFormDataAutoOpenDocumentDuplicateTest");
		}
	}
}