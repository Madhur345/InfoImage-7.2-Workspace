...
/**
 * @author Biswajit INFO-8719 Performing 'Document split' operation by adding
 *         form fields and multpile images with different formats and same class
 *         for a document type of workitem by unchecking Retain status *
 */
public class INFO_8719 extends SuperClassIWM {
	...
	public void testDocSplitDifferentClassUncheckingRetainStatus() {
		Log.startTestCase(
				"INFO_8719_PerformingDocumentSplitOperationByAddingFormFieldsAndMultpileImagesWithDifferentFormatsAndSameClassForADocumentTypeofWorkitemByUncheckingRetainStatus");

		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-8719  is To verify 'Document split' operation by adding form fields and multpile images "
