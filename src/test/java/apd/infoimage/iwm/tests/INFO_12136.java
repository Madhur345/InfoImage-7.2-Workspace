 ...
 * INFO-12136
 * This class verifies deletion of single TIF/JPG/PNG/PDF/RTF page asynchronously under imports when one import is open for folder type of workitem
 */
public class INFO_12136 extends SuperClassIWM{
	...
	public void testVerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForFolderWorkitem(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-12136 is for Verifying deletion of single TIF/JPG/PNG/PDF/RTF page asynchronously under imports when one import is open for folder type of workitem");
		ATUReports.setAuthorInfo("Suman","SEP-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_12136_VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForFolderWorkitemTest");
			...
			Reporter.log("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForFolderWorkitemTest",true);
			ATUReports.add("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForFolderWorkitemTest",true);
			Log.info("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForFolderWorkitemTest");
		...
		{
			e.printStackTrace();
			Reporter.log("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForFolderWorkitemTest Test is failed.", true);
			ATUReports.add("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForFolderWorkitemTest Test is failed.",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForFolderWorkitemTest Test is failed.");
			Log.error(e.getMessage());
		}
		finally {
			Log.endTestCase("INFO_12136_VerifyDeletionOfSinglePageUnderImportsWhenOneImportIsOpenForFolderWorkitemTest");
		}
	}
