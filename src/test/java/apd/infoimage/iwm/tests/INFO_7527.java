...
/**
 * @author SinghAvn - 14-June-2018 INFO-7527 This class will perform 'Document
 *         Duplicate' operation with different class for a document type of
 *         workitem by adding notes to the workitem
 **/
public class INFO_7527 extends SuperClassIWM {
	@BeforeMethod
	public void setUp() {
	...
	public void testVerifyDocumentWorkitemRetrieveFromSearchDifferentClassDocumentDuplicate() {
		...
		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-7537 is Performing 'Document Duplicate' operation with different class for a document type of workitem by adding notes to the workitem");
		...
		try {
			...
			Log.endTestCase(
					"This Scenario INFO-7527 is for Performing Performing 'Document Duplicate' operation with different class for a document type of workitem by adding notes to the workitem");
		}
	}
