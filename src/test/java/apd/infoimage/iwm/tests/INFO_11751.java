 ...
 * @author PradhanJ
 * INFO-11751
 * Test to verify the refreshment of document viewer while adding 'tif' files
 */
public class INFO_11751 extends SuperClassIWM{
	@BeforeMethod
	...
	public void testVerifyRefreshmentOfDocViewerAddingTIFFfile() {
		Log.startTestCase("INFO_11751_VerifyRefreshmentOfDocViewerAddingTIFFfile");
		try {
			ATUReports.setTestCaseReqCoverage(
					"This Scenario INFO-11751 Test to verify the refreshment of document viewer while adding 'tif' files");
			...
			Log.endTestCase("INFO_11751_VerifyRefreshmentOfDocViewerAddingTIFFfile");
		}
	}
