 ...
 * @author PradhanJ
 * INFO-5780
 * To test the Nested Query in IWM Using Query builder for document type of workitems 
 ...
 */
public class INFO_5780 extends SuperClassIWM{
 ...
 + "two tables in SQL query string that is passed as an input");
		...
		try {
			Log.startTestCase(
					"INFO_5780_NestedsearchByPassingATTRIBUTEsAndOBJECTColumnInQueryString");
			...
			if(f9){
				Reporter.log("Workitem is searched successfully by passing ATTRIBUTES and OBJECT column names "
						+ "by joining two tables in query string",true);
				ATUReports.add("Workitem is searched successfully by passing ATTRIBUTES and OBJECT column names "
						+ "by joining two tables in query string", true);
				Log.info("Workitem is searched successfully by passing ATTRIBUTES and OBJECT column names by "
						+ "joining two tables in query string");
			}else{
				ATUReports.add("Nested query by passing ATTRIBUTES and OBJECT column "
			...
			ATUReports.add(
					...
					LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail(" Nested search functionality using ATTRIBUTES and OBJECT column test failed");
		}
		finally {
			Log.endTestCase("INFO_5780_NestedsearchByPassingATTRIBUTEsAndOBJECTColumnInQueryString");
