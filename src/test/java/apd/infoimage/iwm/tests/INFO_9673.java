 ...
 */
public class INFO_9673 extends SuperClassIWM{
	...
	public void testVerifyKeyboardShortcutsExportOfImagesInWorkitem()
	{
		Log.startTestCase("INFO_9673_VerifyKeyboardShortcutsExportOfImagesInWorkitemTest");
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-9673 is for Verifying keyboard shortcuts for Export Of Images in workitem");
		...
		try
		{
			...
			Reporter.log("INFO_9673_VerifyKeyboardShortcutsExportOfImagesInWorkitemTest",true);
			ATUReports.add("INFO_9673_VerifyKeyboardShortcutsExportOfImagesInWorkitemTest",true);
			Log.info("INFO_9673_VerifyKeyboardShortcutsExportOfImagesInWorkitemTest");
		...
		{
			Log.endTestCase("INFO_9673_VerifyKeyboardShortcutsExportOfImagesInWorkitemTest");
		}
	}
}