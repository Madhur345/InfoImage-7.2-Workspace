...
/**
 * @author SinghAvn INFO-11039 Test to verify icon indicating that the workitems
 *         is in workflow for document type of workitem when the workitem is
 *         sent to My Personal Queue
 */
public class INFO_11039 extends SuperClassIWM {
	@BeforeMethod
	public void setUp() {
	...
	public void testVeifySavingCustomJSForm() {
		Log.startTestCase("INFO_11039_VerifyIconForWorkitemOfFolderTypeRetrievedFromPersonalQueue");
		...
		ATUReports.setAuthorInfo("SinghAvn", "AUG-2018", "0.3");
		try {
			prop = new Properties();
