 ...
 * @author PradhanJ
 * @Zypher Id : INFO-8775
 * This Scenario will perform 'Auto view' functionality for 2 workitems from any queue
 */
public class INFO_8775 extends SuperClassIWM{
	...
	{ 
		Log.startTestCase("INFO_8775_GetNextPerformAutoViewForTwoWorkitems");
		try
		{
			ATUReports.setTestCaseReqCoverage("This Scenario INFO-8775  is for Performing 'Auto view' functionality for 2 workitems from any queue");
			...
			//Create 2 workitems and send to default queue
			...
			e.printStackTrace();			
			ATUReports.add("Failed to execute 'Auto view' functionality for 2 workitems from any queue", 
					LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("Failed to execute 'Auto view' functionality for 2 workitems from any queue");
			
		}
		
		finally {
			Log.endTestCase("INFO_8775_GetNextPerformAutoViewForTwoWorkitems");
