...
/**
 * @author DashBisw INFO_11122 This class is To Performing Document Duplicate Operation 
 * With Same Different Class For Document Type Of Workitem With Index Fields Defined 
 * in detailed view Page". 10/08/2018
 */
...
public class INFO_11122 extends SuperClassIWM {
	@BeforeMethod
	public void setUp() {
	...
	public void performingDocumentDuplicateOperationWithSameDifferentClassForDocumentTypeOfWorkitem() {
		...
		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO_11122 is Performing Document Duplicate Operation With Same Different Class For Document Type Of Workitem With Index Fields Defined in detailed view Page");
		ATUReports.setAuthorInfo("Biswajit ", "Aug-2018", "0");

		try {
			Log.startTestCase(
					"INFO_11122_PerformingDocumentDuplicateOperationWithSameDifferentClassForDocumentTypeOfWorkitemWithIndexFieldsDefinedinDetailedViewPage");
			prop = new Properties();
			...
			Reporter.log(
					"Class Name : INFO_11122_PerformingDocumentDuplicateOperationWithSameDifferentClassForDocumentTypeOfWorkitemWithIndexFieldsDefinedinDetailedViewPage",
					true);
			ATUReports.add(
					"Class Name : INFO_11122_PerformingDocumentDuplicateOperationWithSameDifferentClassForDocumentTypeOfWorkitemWithIndexFieldsDefinedinDetailedViewPage",
					true);
			...
			e.printStackTrace();
			Reporter.log("INFO-11122 Failed", true);
			Log.info("INFO-11122 Failed");
			ATUReports.add("INFO-11122 Failed", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
