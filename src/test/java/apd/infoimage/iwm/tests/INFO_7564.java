...
/**
 * @author SinghAvn
 * @Zypher Id: INFO-7564 This Scenario is exporting PDF image to PNG format from
 *         document type of workitem in IWM
 *
 */
public class INFO_7564 extends SuperClassIWM {
	@BeforeMethod
	...
	public void testexportPDFtoPNGformat() {
		...
		try {
			...
			e.printStackTrace();
			Reporter.log("INFO-7564 is failed", true);
			Log.info("INFO-7564 is failed");
			ATUReports.add("INFO-7564 is failed", LogAs.FAILED,
					new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("INFO-7564 is failed");
