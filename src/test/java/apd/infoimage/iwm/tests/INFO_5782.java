 ...
 * "ATTRIBUTES" and "WFIVARS" column names by joining two tables in SQL query string 
 * that is passed as an input
 */
public class INFO_5782 extends SuperClassIWM{
	...
	public void testNestedSearchByPassingATTRIBUTESandWFIVARSinQueryString() {
		ATUReports.setTestCaseReqCoverage(
				"This Scenario INFO-5782 is Test to verify the Nested search functionality "
		...
		try {
			Log.startTestCase(
					"INFO_5782_NestedSearchByPassingATTRIBUTESandWFIVARSinQueryString");
			...
			if(f9){
				Reporter.log("Workitem is searched successfully by passing ATTRIBUTES and WFIVARS "
				...
				ATUReports.add("Nested query by passing ATTRIBUTES and WFIVARS column names by joining"
						+ " two tables in SQL query string  test failed", 
						LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
				Assert.fail("Nested query by passing ATTRIBUTES and WFIVARS column "
			...
			ATUReports.add(
					...
					LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail(" Nested search functionality by passing ATTRIBUTES and WFIVARS column names by joining test failed");
		}
		finally {
			Log.endTestCase("INFO_5782_NestedSearchByPassingATTRIBUTESandWFIVARSinQueryString");
