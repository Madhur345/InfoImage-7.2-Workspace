 ...
 * @author PradhanJ
 * INFO-11752
 * Test to verify the refreshment of document viewer while adding 'pdf' files
 */
public class INFO_11752 extends SuperClassIWM{
	@BeforeMethod
	...
	public void testVerifyRefreshmentOfDocViewerWhileAddingPDFfile() {
		Log.startTestCase("INFO_11752_VerifyRefreshmentOfDocViewerWhileAddingPDFfile");
		try {
			ATUReports.setTestCaseReqCoverage(
					"This Scenario INFO-11752 Test to verify the refreshment of document viewer while adding 'pdf' files");
			...
			if (addNewPageWinPresent) {
				...
				if (docNameInAddNewPageWin) {
					...
					ATUReports.add("Selected PDF file name validation failed.", true);
			...
			Log.endTestCase("INFO_11752_VerifyRefreshmentOfDocViewerWhileAddingPDFfile");
		}
	}
