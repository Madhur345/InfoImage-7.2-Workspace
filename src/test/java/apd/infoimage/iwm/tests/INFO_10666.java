...
public class INFO_10666 extends SuperClassIWM {
	@BeforeMethod
	public void setUp() {
	...
	public void VerifyReturntoQueuFunctionalityForFolderTypeOfWorkitem() {
		Log.startTestCase("INFO_10666_VerifyReturntoQueuFunctionalityForWorkitemOfDocumentTypeRetrievedFromPersonalQueue");
		ATUReports.setTestCaseReqCoverage("This Scenario INFO-10666 is for verify 'Return to Queue' functionality for My personal queue for Document type of workitem");
		...
		try {
			...
			Reporter.log(
					"INFO-10666 is for verify 'Return to Queue' functionality for My personal queue for Document type of workitem test failed",
					true);
			ATUReports.add(
					" INFO-10666 is for verify 'Return to Queue' functionality for My personal queue for Document type of workitem test failed",
			...
			Log.endTestCase(
					"INFO-10666 is for verify 'Return to Queue' functionality for My personal queue for Document type of workitem");
		}
	}
}
