 ...
 * INFO-12500
 * This class verifies the scroll bar under content for Less Than Ten Pages for document type of workitem
 */
public class INFO_12500 extends SuperClassIWM{
	...
	public void testVerifyScrollBarUnderContentForLessThanTenPagesForDocumentWorkitem(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO_12500 is for Verifying the scroll bar under content for Less Than Ten Pages for document type of workitem");
		ATUReports.setAuthorInfo("Suman","AUG-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_12500_VerifyScrollBarUnderContentForLessThanTenPagesForDocumentWorkitemTest");
			...
			Reporter.log("VerifyScrollBarUnderContentForLessThanTenPagesForDocumentWorkitemTest",true);
			ATUReports.add("VerifyScrollBarUnderContentForLessThanTenPagesForDocumentWorkitemTest",true);
			Log.info("VerifyScrollBarUnderContentForLessThanTenPagesForDocumentWorkitemTest");
			...
			if(addNewPageWinPresent)
			{
				...
				if (addSecondNewPageWinPresent) {
					...
					util.wait(time);
					util.jclick(wdp.getAddNewPageUploadBtn());
					Reporter.log("Add New Page Upload Button is clicked", true);
					ATUReports.add("Add New Page Upload Button is clicked", true);
					util.waitForPageToLoad();
