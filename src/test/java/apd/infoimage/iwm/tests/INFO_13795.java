 ...
 * INFO-13795
 * This class verifies the scroll bar under content for Greater Than Fifteen Pages for Unreserved document type of workitem
 */
public class INFO_13795 extends SuperClassIWM{
	...
	public void testVerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitem(){
		ATUReports.setTestCaseReqCoverage("This Scenario INFO_13795 is for Verifying the scroll bar under content for Greater Than Fifteen Pages for Unreserved document type of workitem");
		ATUReports.setAuthorInfo("Suman","SEP-2018","0.3"); 
		try
		{
			DOMConfigurator.configure("log4j.xml");
			Log.startTestCase("INFO_13795_VerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitemTest");
			...
			Reporter.log("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitemTest",true);
			ATUReports.add("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitemTest",true);
			Log.info("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitemTest");
		...
		catch(Exception e)
		{
			...
			Reporter.log("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitem test is failed", true);
			Log.info("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitem test is failed");
			ATUReports.add("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitem test is failed",LogAs.FAILED,new CaptureScreen(ScreenshotOf.DESKTOP));
			Assert.fail("VerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitem test is failed");		
		}		
		finally {
			Log.endTestCase("INFO_13795_VerifyScrollBarUnderContentForGreaterThanFifteenPagesForUnreservedDocumentWorkitemTest");
		}
	}
}
