...
/**
 * @author DashBisw INFO_11071  This class is To verify 
 * "Alert Message At The Time You Type A Not Supported Character In The Workitem 
 * Name Field While Performing Rename Workitem For 	Folder Type Of Workitem". 30/07/2018
 */
...
public class INFO_11071 extends SuperClassIWM {
	...
	public void VerifyAlertMessage() {
		Log.startTestCase("INFO_11071_VerifyWarningMessageAtTheTimeYouTypeAUnSupportedCharacterInTheWorkitemNameField");
		try {
			ATUReports.setTestCaseReqCoverage("This Scenario INFO_11071  is To verify"
					+ "Alert Message At The Time You Type A Not Supported Special Character In The Workitem Name Field");
			...
			Log.endTestCase(
					"INFO_11071_VerifyWarningMessageAtTheTimeYouTypeAUnSupportedCharacterInTheWorkitemNameField");
