 ...
 * @author PradhanJ
 * INFO-13404
 * To test add folder under category in File Plan of RM application
 */
public class INFO_13404_VerifyAddFolderUnderFilePlanInRM extends SuperClassIWM{
	@BeforeMethod
	...
	@Test
	public void testVerifyAddFolderUnderFilePlanInRM()
	{
		try {
			Log.startTestCase("INFO_13404_VerifyAddFolderUnderFilePlanInRM");
			ATUReports.setTestCaseReqCoverage(
					"This Scenario INFO-13404  is To test add folder under category in File Plan of RM application");
			...
			Log.endTestCase("INFO_13404_VerifyAddFolderUnderFilePlanInRM");
		}
	}
