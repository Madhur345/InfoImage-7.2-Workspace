 ...
 * @author PradhanJ
 * INFO-13405
 * To test Edit Folder under File plan in RM application
 */
public class INFO_13405_VerifyEditFolderUnderFilePlanInRM extends SuperClassIWM{
	...
	@Test
	public void testVerifyEditFolderUnderFilePlanInRM()
	{
		try {
			Log.startTestCase("INFO_13405_VerifyEditFolderUnderFilePlanInRM");
			...
			Log.endTestCase("INFO_13405_VerifyEditFolderUnderFilePlanInRM");
		}
	}
}
